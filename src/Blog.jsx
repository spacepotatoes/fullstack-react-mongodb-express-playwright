  ...
  return (
    <div className='min-h-screen bg-base-200'>
      ...
      <div className='max-w-7xl mx-auto px-4 py-12'>
        ...
        {/* Pill-Buttons – jetzt OHNE Gradient, sauberer Look */}
              ...
              className={`px-8 py-3 rounded-full font-bold text-sm tracking-wide border-2 transition-all duration-300
                ${
                  author === (name === 'Alle' ? '' : name)
                    ...
                    : 'bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 hover:border-pink-500 text-gray-800 dark:text-gray-200'
                }`}
            >
              {name}
            </button>
        ...
        {/* Filter + Sort – NUR DIE 2 LABELS GEFIXT */}
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-20'>
          <div>
            <label
              htmlFor='author-filter'
              className='block text-sm font-semibold text-base-content/80 mb-3'
            >
              Filter by author
            </label>
            <input
        ...
        {/* CREATE POST GANZ UNTEN – wie gewünscht */}
